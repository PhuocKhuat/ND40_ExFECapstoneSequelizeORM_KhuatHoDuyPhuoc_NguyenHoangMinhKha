...
import { BASE_IMG_URL, GET_SAVED_IMAGE_SAGA } from "../../../action/action";

export default function SavedImage() {
  const { listOfSavedImage } = useSelector((state) => state.reducerUserInfo);
      ...
      <div className="p-4 lg:w-1/4 md:w-1/2">
        <div className="h-full flex flex-col items-center text-center">
          ...
          <div className="w-full">
            ...
            <p className="mb-4 truncate">{item.img.description}</p>
